...
import davos.sdo.impl.binding.SDOCompiler;
 ...
 * Time: 3:41:28 PM
 */
public class SDOCompileTask extends MatchingTask
{
    ...
    public void execute() throws BuildException
    {
        ...
        {
            // We need to set the base dir to the base directory of
            // the Ant file where this is called
            theBasedir = getProject().getBaseDir();
        }
        ...
        try
        {
            ...
            {
                tmpdir = SDOCompiler.createTempDir(null);
            }
            if (srcgendir == null)
            ...
            // generate the source
            SDOCompiler.Parameters params = new SDOCompiler.Parameters();
            ...
            success = SDOCompiler.compile(params);
            ...
            if (tmpdir != null) {
                SDOCompiler.tryHardToDelete(tmpdir);
            }
        }
    ...
    /**
     * If set to true, then set, isSet and create methods will not be generated
     * @param noExtraMethods value to assign to noExtraMethods
     */
    ...
    public String getSdoAnonTypeNames()
    {
        switch (namingOption)
        {
        case Options.NAMES_STANDARD:
            return "namesStandard";
        case Options.NAMES_COMPOSITE:
            return "namesComposite";
        }
        return null;
    }

    /*
     * Sets the algorithm used to generate SDO names from Schema
     */
    public void setSdoAnonTypeNames(String namingForAnonymousTypes)
    {
