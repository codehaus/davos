 ...
 */
public class HarmonyHashMap<K, V>
    extends HarmonyAbstractMap<K, V>
    implements Map<K, V>, Cloneable, Serializable
{
    ...
    static class HashMapIterator<E, KT, VT> implements Iterator<E>
    {
        ...
        final HarmonyMapEntry.Type<E, KT, VT> type;
        ...
        final HarmonyHashMap<KT, VT> associatedMap;

        HashMapIterator(HarmonyMapEntry.Type<E, KT, VT> value, HarmonyHashMap<KT, VT> hm) {
            associatedMap = hm;
            type = value;
    ...
    static class HashMapEntrySet<KT, VT> extends AbstractSet<Map.Entry<KT, VT>>
    {
        ...
        public Iterator<Map.Entry<KT, VT>> iterator() {
            return new HashMapIterator<Map.Entry<KT, VT>, KT, VT>(
                    new HarmonyMapEntry.Type<Map.Entry<KT, VT>, KT, VT>() {
                        public Map.Entry<KT, VT> get(HarmonyMapEntry<KT, VT> entry) {
                            return entry;
                        }
                    }, associatedMap);
        }
        ...
        if (keySet == null) {
            keySet = new AbstractSet<K>() {
                ...
                public boolean remove(Object key) {
                    if (containsKey(key)) {
                        HarmonyHashMap.this.remove(key);
                        return true;
                    }
                    return false;
                }
                ...
                public Iterator<K> iterator() {
                    return new HashMapIterator<K, K, V>(
                            new HarmonyMapEntry.Type<K, K, V>() {
                                public K get(HarmonyMapEntry<K, V> entry) {
                                    return entry.key;
                                }
                            }, HarmonyHashMap.this);
                }
    ...
    Entry<K, V> createEntry(K key, int index, V value) {
        Entry<K, V> entry = createNewEntry(key, value);
        entry.next = elementData[index];
        elementData[index] = entry;
        return entry;
    }

    Entry<K, V> createNewEntry(K key, V value)
    {
            ...
            valuesCollection = new AbstractCollection<V>() {
                ...
                public Iterator<V> iterator() {
                    return new HashMapIterator<V, K, V>(
                            new HarmonyMapEntry.Type<V, K, V>() {
                                public V get(HarmonyMapEntry<K, V> entry) {
                                    return entry.value;
                                }
                            }, HarmonyHashMap.this);
                }
